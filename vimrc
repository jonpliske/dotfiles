...
" If linux and not NeoVim, set ttymouse
...
if has("autocmd")
    ...
    " autocmd group for easy deletion
    augroup vimrcEx
        au!

        " text files 'textwidth' 78 characters
...
" just kiddin' about insert mode ;)
imap jk <ESC>l

nnoremap <F6> :setlocal spell! spell?<CR>

" Select search pattern, don't jump to next
